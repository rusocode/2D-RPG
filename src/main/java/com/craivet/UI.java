...
public class UI {
    ...
    private void drawTitleScreen() {
        if (titleScreenState == MAIN_SCREEN) {
            ...
            y += tile_size * 2;
            g2.drawImage(world.player.animation.movement[0], x, y, tile_size * 2, tile_size * 2, null);
    ...
    private void drawSleepScreen() {
        ...
        if (counter >= 120) {
            ...
            if (world.environment.lighting.filterAlpha <= 0f) {
                ...
                game.state = PLAY_STATE;
                world.player.animation.loadMovementFrames(player_movement, ENTITY_WIDTH, ENTITY_HEIGHT, tile_size);
