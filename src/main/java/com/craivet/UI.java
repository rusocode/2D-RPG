...
public class UI {
	...
	public void optionsTop(int frameX, int frameY) {
		...
		if (commandNum == 0) {
			...
			if (game.keyH.enter) {
				if (!game.fullScreenOn) game.fullScreenOn = true;
				else if (game.fullScreenOn) game.fullScreenOn = false;
				subState = 1;
			}
		}
